...
#define FORMAT_TYPE_PTR 0x0900
#define FORMAT_TYPE_STR 0x0d00
#define FORMAT_TYPE_SIZE_T 0x0b00
...
int vsnprintf(char *buf, int size, const char *fmt, va_list args)
{
    ...
    while(*fmt){
        ...
        //}else if (FORMAT_FLAG(spec) & FORMAT_FLAG_WIDTH){
            // do nothing;
